...
#   add_epred_draws(PLFAtot_PCA_06New) %>%
#   ggplot(aes(x = Dim.1             , y = totalPLFA, color = ordered(PlaSpe))) +
...
# 
# plot (conditional_effects(PLFAtot_PCA_06, effects = "Dim.1",  ndraws = 1000, spaghetti = F,  
#                           prob = 0.5, conditions = NULL), points =T)
# 
# plot (conditional_effects(PLFAtot_PCA_06, effects = "Dim.1:DW_above",  ndraws = 10000, spaghetti = F,  
#                          prob = 0.9), points =T)
# 
# plot (conditional_effects(PLFAtot_PCA_06, effects = "DW_above",  ndraws = 10000, spaghetti = F,  
#                           prob = 0.9), points =T)
# 
# plot (conditional_effects(PLFAtot_PCA_06, effects = "Dim.1:DW_above",  ndraws = 10000, spaghetti = F,  
#                           prob = 0.9, conditions = "DW_roots"), points =T)
...
# conditions2 = make_conditions (PLFAtot_PCA_02, "DW_above")
# 
# 
# plot (conditional_effects(PLFAtot_PCA_02, effects = "RelGenSpec:DW_roots",  ndraws = 10000, spaghetti = F,  
#                     prob = 0.5, conditions = conditions2), points = F)


#  

get_variables(PLFAtot_PCA_06)
#PLFAtot_PCA_06 %>%  spread_draws(b_Dim.1, sigma) %>%  median_qi()


summary (lm (totalBact ~ DW_roots+Dim.1 + DW_above , data = dataNLPL))

# Appendix S2: Figure S 6 pp check ####
